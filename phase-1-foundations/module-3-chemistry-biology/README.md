...
**Duration:** 8-10 weeks | **Cognitive Load:** Medium | **Priority:** Essential

### Minimal Friction Resource Table

| Resource Type | Primary Choice | Why This One | Access | Backup Option |
|---------------|----------------|--------------|---------|---------------|
| **Video Course** | [Khan Academy Chemistry](https://www.khanacademy.org/science/chemistry) | Visual, interactive, comprehensive, zero barriers | Free | [MIT 5.111 Chemical Science](https://ocw.mit.edu/courses/5-111-principles-of-chemical-science-fall-2008/) |
| **Textbook** | Chemistry: The Central Science (Brown, LeMay) | Gold standard, clear explanations, excellent problems | Library/Purchase | Khan Academy articles (free) |
| **Interactive Practice** | [Khan Academy Chemistry Exercises](https://www.khanacademy.org/science/chemistry) | Immediate feedback, adaptive learning | Free | ChemCollective simulations |
| **Visual Models** | [PhET Chemistry Simulations](https://phet.colorado.edu/en/simulations/category/chemistry) | Molecular-level visualization | Free | ChemSketch molecular modeling |
| **Lab Simulations** | [ChemCollective Virtual Labs](http://chemcollective.org/vlabs) | Safe virtual experiments | Free | LabXchange virtual labs |

### Optimized Study Schedule

| Weeks | Focus | Daily Time | Key Milestone |
|-------|-------|------------|---------------|
| **1-2** | Atomic Structure & Periodicity | 1.5-2 hours | Predict element properties |
| **3-4** | Chemical Bonding & Geometry | 2 hours | Draw Lewis structures fluently |
| **5-6** | Stoichiometry & Reactions | 2 hours | Balance equations and calculate yields |
| **7-8** | Thermochemistry & Equilibrium | 2-2.5 hours | Apply Le Chatelier's principle |
| **9-10** | Acids, Bases & Electrochemistry | 2-2.5 hours | Calculate pH and cell potentials |
...
- ✅ Chemical stoichiometry and limiting reagents
...
| Weeks | Focus | Daily Time | Key Milestone |
|-------|-------|------------|---------------|
| **1-2** | Structure, Bonding & Nomenclature | 2 hours | Name and draw organic molecules |
| **3-4** | Stereochemistry & Conformations | 2-2.5 hours | Identify chirality and stereoisomers |
| **5-6** | Substitution & Elimination | 2.5-3 hours | Predict SN1/SN2/E1/E2 mechanisms |
| **7-8** | Addition Reactions & Aromatics | 2.5-3 hours | Handle alkene and aromatic chemistry |
| **9-10** | Carbonyls & Synthesis Planning | 3 hours | Design multi-step syntheses |

### Core Topics Mastery Checklist
- ✅ Hybridization and molecular geometry
- ✅ IUPAC nomenclature for major functional groups
...
- ✅ Elimination reactions (E1, E2) and Zaitsev's rule
...
| Resource Type | Primary Choice | Why This One | Access | Backup Option |
|---------------|----------------|--------------|---------|---------------|
| **Video Course** | [Khan Academy Biology](https://www.khanacademy.org/science/biology) | Comprehensive, visual, well-organized | Free | [MIT 7.012 Introduction to Biology](https://ocw.mit.edu/courses/7-012-introduction-to-biology-fall-2004/) |
| **Textbook** | Molecular Biology of the Cell (Alberts et al.) | The definitive textbook, comprehensive coverage | Library/Purchase | Campbell Biology (library) |
| **Interactive Models** | [BioInteractive](https://www.biointeractive.org/) | HHMI animations and interactive models | Free | Protein Data Bank visualizations |
| **Lab Simulations** | [LabXchange](https://www.labxchange.org/) | Virtual biology labs and simulations | Free | PhET biology simulations |
| **Molecular Visualization** | [PyMOL](https://pymol.org/) or [ChimeraX](https://www.cgl.ucsf.edu/chimerax/) | 3D protein and DNA structures | Free | NCBI Structure viewer |

### Optimized Study Schedule

| Weeks | Focus | Daily Time | Key Milestone |
|-------|-------|------------|---------------|
| **1-2** | Cell Components & Macromolecules | 2 hours | Understand protein structure-function |
| **3-4** | DNA, Replication & Repair | 2-2.5 hours | Explain DNA replication machinery |
| **5-6** | Gene Expression & Regulation | 2.5 hours | Trace gene to protein pathway |
| **7-8** | Membrane & Transport Systems | 2.5 hours | Understand cellular transport |
| **9-10** | Cell Signaling & Cell Cycle | 2.5-3 hours | Analyze signaling pathways |

### Core Topics Mastery Checklist
- ✅ Protein structure: primary through quaternary
- ✅ Enzyme kinetics and regulation
- ✅ DNA structure, packaging, and chromatin
- ✅ DNA replication machinery and fidelity
- ✅ Transcription: initiation, elongation, termination
- ✅ RNA processing: splicing, capping, polyadenylation
- ✅ Translation: ribosome structure and mechanism
- ✅ Gene regulation: transcriptional and post-transcriptional
...
**Duration:** 4-6 weeks | **Cognitive Load:** Medium-High | **Priority:** Important

### Minimal Friction Resource Table

| Resource Type | Primary Choice | Why This One | Access | Backup Option |
|---------------|----------------|--------------|---------|---------------|
| **Video Course** | [Khan Academy Genetics](https://www.khanacademy.org/science/biology/classical-genetics) | Clear progression from classical to molecular | Free | [MIT 7.03 Genetics](https://ocw.mit.edu/courses/7-03-genetics-fall-2004/) |
| **Textbook** | Genetics: From Genes to Genomes (Hartwell) | Modern integrated approach | Library/Purchase | Khan Academy articles (free) |
| **Interactive Tools** | [NCBI Genome Browser](https://www.ncbi.nlm.nih.gov/genome/) | Real genomic data exploration | Free | Ensembl Genome Browser |
| **Bioinformatics** | [Galaxy Project](https://galaxyproject.org/) | Web-based genomic analysis | Free | NCBI BLAST tools |
| **Modern Applications** | [Nature Genetics Papers](https://www.nature.com/ng/) | Current research and applications | Free (abstracts) | CRISPR educational resources |

### Optimized Study Schedule

| Weeks | Focus | Daily Time | Key Milestone |
|-------|-------|------------|---------------|
| **1-2** | Classical Genetics | 1.5-2 hours | Solve Mendelian inheritance problems |
| **3-4** | Molecular Genetics | 2 hours | Understand gene expression control |
| **5-6** | Genomics & Modern Applications | 2-2.5 hours | Analyze genomic data and CRISPR |

### Core Topics Mastery Checklist
- ✅ Mendelian inheritance patterns
- ✅ Chromosome theory and linkage analysis
